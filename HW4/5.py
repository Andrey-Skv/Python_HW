...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("dz51.txt", create_str(koef1))
write_file("dz52.txt", create_str(koef2))

# нахождение суммы многочлена

with open('dz51.txt', 'r') as data:
    st1 = data.readlines()
with open('dz52.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("dz5_res.txt", create_str(lst_new))
with open('dz5_res.txt', 'r') as data:
    st3 = data.readlines()
